...
data_dir = Path(r"/mnt/disks/persist/images/laion2B-en-aesthetic")


output_image_foder = Path("/mnt/disks/persist/datasets/3m/images")
Path(output_image_foder).mkdir(parents=True, exist_ok=True)

output_conditioning_image_foder = Path("/mnt/disks/persist/datasets/3m/conditioning_images")
